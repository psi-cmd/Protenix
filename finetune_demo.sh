...
# wget -P /af3-dev/release_model/ https://af3-dev.tos-cn-beijing.volces.com/release_model/model_v0.3.0.pt
checkpoint_path="/af3-dev/release_model/model_v0.3.0.pt"
